...
namespace Horn.Services.Core.Builder
{
    public class SiteStructureBuilder : ISiteStructureBuilder
    {
        ...
        private readonly string[] excludePackages = new[] { "cms", "viewengines", "json", "languages", "castle", "network", "boo", "n2cms", "network", "network", "dndns", "hasic", "moq", "json.net", "hasic", "sharp.architecture", "castle.nvelocity", "castle.templateengine", "caliburn-silverlight", "automapper" };
